...
class ActionSheetWithInset extends React.Component {
    ...
    render () {
        ...
        const backgroundColorStyle = darkMode ? styles.backgroundColorDark : styles.backgroundColor;
        return visible ? (
            // <Modal visible={visible}
            //        animationType='none'
            //        transparent
            //        // style={{bottom: -100, backgroundColor: 'red'}}
            //        supportedOrientations={this.props.supportedOrientations || this.defaultOrientations}
            //        onRequestClose={this._cancel}
            //        statusBarTranslucent={this.props.statusBarTranslucent}
            // >
            <Pressable style={{position: 'absolute', bottom: this.props.insets.bottom, left: 0, right: 0, top: 0, zIndex: 9999}}>
                <SafeAreaView style={[styles.wrapper]}>
                    ...
                    >
                        ...
                        <View style={[boxStyle, { marginTop: 8}, backgroundColorStyle]}>
